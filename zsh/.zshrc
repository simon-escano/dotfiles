...
alias tree='eza --icons -a --tree --group-directories-first --ignore-glob "node_modules|.git|dist|*.log"'
...
frg() {
  ...
  fzf --ansi --disabled --query "$INITIAL_QUERY" \
      ...
      --bind "ctrl-f:unbind(change,start)+change-prompt(2. fzf> )+enable-search+clear-query" \
      --delimiter : \
